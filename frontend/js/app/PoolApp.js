...
// -----------------------------
  ...
  _setSectionOverlay(bounds, enabled, cutY = null, wallThickness = 0.2) {
    ...
    const addSectionBand = (x0, x3, includeWaterTint = true) => {
      ...
      // User-requested fix: suppress the left pool wall section cap.
      if (false && !shouldHideSpaSidePoolWallCap.left) {
      ...
      // User-requested fix: suppress the matching left coping section cap.
      if (false && !shouldHideSpaSidePoolWallCap.left) {
