  ...
  _setSectionFrontShellHidden(centerY, hidden) {
    ...
    roots.forEach((root) => {
      root.traverse((obj) => {
        ...
        // End walls at the far pool left/right can also sit in front of the
        // section plane. Hide those thin-X pool walls so the section reads as a
        // clean cut instead of showing shell geometry projecting past the cut.
