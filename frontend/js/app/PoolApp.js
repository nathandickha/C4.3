...
// -----------------------------
  ...
  _trimPoolWallOnSpaSideAtSection(sectionY, enabled) {
    ...
    this.poolGroup.traverse((obj) => {
      ...
      // Only east/west walls need shortening along local Y.
      ...
      // Correct direction: keep the half BEHIND the section cut (same direction
      // as the earlier patch that had the wall half correct).
